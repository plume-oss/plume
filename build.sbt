...
lazy val souffle     = Projects.souffle
lazy val tigergraph  = Projects.tigergraph
lazy val tinkergraph = Projects.tinkergraph

lazy val root = (project in file("."))
  .dependsOn(commons, base, gremlin, tinkergraph, neptune, neo4j, souffle, tigergraph, overflowDb)
  .aggregate(commons, base, gremlin, tinkergraph, neptune, neo4j, souffle, tigergraph, overflowDb)
