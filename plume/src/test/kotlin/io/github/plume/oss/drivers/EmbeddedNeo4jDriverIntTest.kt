...
class EmbeddedNeo4jDriverIntTest {

    companion object {
        lateinit var driver: EmbeddedNeo4jDriver
        ...
        fun setUpAll() = run {
            ...
            driver = (DriverFactory(GraphDatabase.NEO4J_EMBEDDED) as EmbeddedNeo4jDriver)
                .databaseDirectory("$tempDir/plume/")
                .database("neo4j")
                .connect()
            assertEquals("$tempDir/plume/", driver.databaseDirectory)
        ...
        @AfterAll
        fun tearDownAll() =
            println("${EmbeddedNeo4jDriverIntTest::class.java.simpleName} completed in ${(System.nanoTime() - testStartTime) / 1e6} ms")
    }
